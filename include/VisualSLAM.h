...
class VisualSLAM {
 ...
 public:
  ...
  void readGroundTruthData(std::string fileName,
                           int numberFrames,
                           std::vector<Sophus::SE3> &groundTruthData);

  void plotTrajectoryNextStep(cv::Mat &window,
                              int index,
                              ...
                              Eigen::Matrix3d &cumR,
                              Sophus::SE3 pose,
                              Sophus::SE3 prevPose = Sophus::SE3(Eigen::Matrix3d::Identity(),
                                                                 Eigen::Vector3d(0, 0, 0)));
//    void setReInitialtoFalse();
};